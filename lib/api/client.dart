// Dio HTTP client for Melody-api. Single source of truth for the base URL,
...
Dio buildMelodyDio() {
  final dio = Dio(
    BaseOptions(
      baseUrl: MelodyApiEnv.baseUrl,
      connectTimeout: const Duration(seconds: 10),
      receiveTimeout: const Duration(seconds: 20),
      headers: const {'Accept': 'application/json'},
      // Melody-api wraps responses in { status, message, data, ... } — we want
