        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Row(
                children: [
                  _CastMedallion(accent: accent, active: s.isCasting),
      ...
      child: Stack(
        ...
        children: [
          ...
          Container(
            ...
            child: Icon(
              active ? SolarIconsBold.screencast : SolarIconsOutline.screencast,
              color: accent,
              size: 20,
            ),
          ),
        ...
        children: [
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        eyebrow(
                          'NOW PLAYING ON ${(deviceName ?? '').toUpperCase()}',
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              child: Row(
                children: [
                  Icon(SolarIconsOutline.linkBroken, size: 16, color: c.fgDim),
