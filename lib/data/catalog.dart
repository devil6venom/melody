...
const List<Track> kTracks = [
  ...
  Track(
    id: 't30',
    title: 'Holland Avenue',
    artist: 'June Halliday',
    album: 'a04',
    duration: 215,
    plays: '11.2M',
  ),
...
const List<Playlist> kPlaylists = [
  ...
  Playlist(
    ...
    tracks: 41,
    hours: '2h 48m',
    sub: 'Your saved warm-electronic things.',
  ),
  Playlist(
    id: 'p03',
  ...
  Playlist(
    id: 'p06',
    title: 'Saturday Bedroom',
    curator: 'You',
    tracks: 47,
    hours: '3h 02m',
    sub: 'Long, warm, untidy.',
  ),
];
...
const List<Podcast> kPodcasts = [
  Podcast(
    id: 'pd01',
    title: 'Long Form, Slowly',
    host: 'Avery Park',
    cadence: 'Weekly',
    episodes: 142,
    sub:
        'Two-hour conversations with the people building the small, strange things of the internet.',
  ),
  Podcast(
    id: 'pd02',
    ...
    episodes: 88,
    sub: 'Short essays read aloud — fiction, criticism, a little philosophy.',
  ),
  Podcast(
    id: 'pd03',
    title: 'Tideline',
    ...
    cadence: 'Monthly',
    episodes: 31,
    sub: 'A field recording show. We go somewhere and listen.',
  ),
  Podcast(
    id: 'pd04',
    title: 'Soft Industry',
    ...
    cadence: 'Weekly',
    episodes: 204,
    sub: 'Designers, makers, and the quieter half of the design industry.',
  ),
];
...
const List<Episode> kEpisodes = [
  Episode(
    ...
    pod: 'pd01',
    num: 142,
    title: 'On building things you can hold',
    date: 'May 18',
    duration: '1h 48m',
    sub:
        'A conversation with a printmaker in Marfa about the long arc of slow work.',
  ),
  Episode(
    id: 'e02',
    pod: 'pd01',
    num: 141,
    title: 'The fourth quiet redesign',
    date: 'May 11',
    duration: '2h 12m',
    sub:
        'Three product designers on the redesigns nobody talks about — the ones that smooth a surface they didn’t name.',
  ),
  Episode(
    id: 'e03',
    pod: 'pd01',
    num: 140,
    title: 'A small bookshop, a long lease',
    date: 'May 04',
    duration: '1h 56m',
    sub: 'Twenty-one years of an independent shop in Lisbon.',
  ),
  Episode(
    id: 'e04',
    pod: 'pd01',
    num: 139,
    title: 'The map is a kind of permission',
    date: 'Apr 27',
    duration: '2h 04m',
    sub: 'A cartographer on how a place changes once it is drawn.',
  ),
  Episode(
    id: 'e05',
    pod: 'pd01',
    num: 138,
    title: 'Studio visit — the ceramicist',
    date: 'Apr 20',
    duration: '1h 41m',
    sub: '',
  ),
  Episode(
    ...
    pod: 'pd01',
    num: 137,
    title: 'Maintenance as authorship',
    date: 'Apr 13',
    duration: '2h 18m',
    sub: '',
  ),
...
const List<Mix> kMixes = [
  Mix(
    id: 'm01',
    title: 'Daily Mix 01',
    sub: 'Aerial Trust, OKO, Sable & Ash + 47 more',
  ),
  Mix(
    id: 'm02',
    title: 'Daily Mix 02',
    sub: 'Niamh Calder, June Halliday + 42 more',
  ),
